...
// Estoque inicial (usado apenas para inicializar a sessão na primeira visita)
if (!isset($_SESSION['estoque'])) {
    $_SESSION['estoque'] = 20;
}
if (!isset($_SESSION['estoque_inicial'])) {
    $_SESSION['estoque_inicial'] = $_SESSION['estoque'];
}
...
// Se o estoque já zerou, redireciona direto para a página de esgotado
